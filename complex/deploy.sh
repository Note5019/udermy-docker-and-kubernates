...
docker build -t stephengrider/multi-server:latest -t stephengrider/multi-client:$SHA -f ./server/Dockerfile ./server
docker build -t stephengrider/multi-worker:latest -t stephengrider/multi-client:$SHA -f ./worker/Dockerfile ./worker
